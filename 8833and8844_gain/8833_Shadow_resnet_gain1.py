...
a = 10
dataset = pd.read_csv(r'/home/wwj/chenqiliang/ceshiyongde/208833All-channel_matrix_p_10.csv').iloc[:, 1:]
dataset = np.asarray(dataset, np.float32)
dataset = dataset.reshape(dataset.shape[0], 8, 8, 1)
label = pd.read_csv(r'/home/wwj/chenqiliang/ceshiyongde/208833gain_labels_p_10.csv').iloc[:, 1]
