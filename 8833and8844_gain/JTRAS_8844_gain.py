...
def JTRAS_Gain_Algorithm_8844(A1):
    ...
    return max_G, selected_transmit_list[0], selected_transmit_list[1], selected_transmit_list[2], \
...
dataset = pd.read_csv(open(r'/home/wwj/chenqiliang/ceshiyongde/208844All-channel_matrix_p_10.csv')).iloc[:, 1:]
...
for i in range(0, 200000):
    list = []
    print(i)
    subGain, i1_Gain, i2_Gain, i3_Gain, i4_Gain, j1_Gain, j2_Gain, j3_Gain, j4_Gain = JTRAS_Gain_Algorithm_8844(
        dataset[i])
    subGain_List.append(subGain)
    #list = [i1_Gain, i2_Gain, i3_Gain, i4_Gain, j1_Gain, j2_Gain, j3_Gain, j4_Gain]

    gainLabel_List.append(GetLabel(i1_Gain, i2_Gain, i3_Gain, i4_Gain, j1_Gain, j2_Gain, j3_Gain, j4_Gain))

subGainData = pd.DataFrame(subGain_List)

gainLabelData = pd.DataFrame(gainLabel_List)

subGainData.to_csv(r'/home/wwj/chenqiliang/8833and8844shuju/8844JTRAS_subgain_10.csv')
gainLabelData.to_csv(r'/home/wwj/chenqiliang/8833and8844shuju/8844JTRAS_gain_label_10.csv')
