...
from uitls_8844_capacity import computation_time
import math
...
a = 50
dataset = pd.read_csv(r'/home/wwj/chenqiliang/ceshiyongde/208844All-channel_matrix_p_10.csv').iloc[:, 1:]
dataset = np.asarray(dataset, np.float32)
dataset = dataset.reshape(dataset.shape[0], 8, 8, 1)
label = pd.read_csv(r'/home/wwj/chenqiliang/ceshiyongde/208844capacity_labels_p_10.csv').iloc[:, 1]
...
for i in range(20000):
    ...
    Pre_subCapacity= np.log2(np.linalg.det(I2 + a *  Pre_sub.T *  Pre_sub / 4))
