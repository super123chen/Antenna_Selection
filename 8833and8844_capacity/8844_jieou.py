...
from uitls_8844_capacity import decoupledSelection_8844,maxChannelCapacity_8844, computation_time


a = 50


dataset = pd.read_csv(open(r"/home/wwj/chenqiliang/ceshiyongde/208844All-channel_matrix_p_40.csv")).iloc[:, 1:]

dataset = np.asarray(dataset, np.float32)
dataset = dataset.reshape(dataset.shape[0], 8, 8, 1)

label = pd.read_csv(open(r"/home/wwj/chenqiliang/ceshiyongde/208844capacity_labels_p_40.csv")).iloc[:, 1]
...
for i in range(40000):
    ...
    testStart = time()
    Pre_subCapacity = decoupledSelection_8844(ArrayA,a)
    test = time() - testStart
