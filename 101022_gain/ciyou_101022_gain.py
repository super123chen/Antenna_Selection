...
a = 10
dataset = pd.read_csv(r'/home/wwj/chenqiliang/101022data/102All-channel_matrix_p_10.csv').iloc[:, 1:]
dataset = np.asarray(dataset, np.float32)
dataset = dataset.reshape(dataset.shape[0], 10, 10, 1)
label = pd.read_csv(r'/home/wwj/chenqiliang/101022data/102JTRAS_gain_label_10.csv').iloc[:, 1]
