...
from uitls_9922_capcacity import decoupledSelection_9922,maxChannelCapacity_9922, computation_time


a = 50


dataset = pd.read_csv(open(r"/home/wwj/chenqiliang/101022data/92All-channel_matrix_p_50.csv")).iloc[:, 1:]

dataset = np.asarray(dataset, np.float32)
dataset = dataset.reshape(dataset.shape[0], 9, 9, 1)

label = pd.read_csv(open(r"/home/wwj/chenqiliang/101022data/92capacity_labels_p_50.csv")).iloc[:, 1]
...
for i in range(20000):
    ...
    testStart = time()
    Pre_subCapacity = decoupledSelection_9922(ArrayA,a)
    test = time() - testStart
