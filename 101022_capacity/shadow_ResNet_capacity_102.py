...
a = 50
dataset = pd.read_csv(r'/home/wwj/chenqiliang/101022data/102All-channel_matrix_p_50.csv').iloc[:, 1:]
dataset = np.asarray(dataset, np.float32)
dataset = dataset.reshape(dataset.shape[0], 10, 10, 1)
label = pd.read_csv(r'/home/wwj/chenqiliang/101022data/102capacity_labels_p_50.csv').iloc[:, 1]
