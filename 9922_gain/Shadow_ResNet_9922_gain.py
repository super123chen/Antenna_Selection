...
from uitls_9922_gain import computation_time
import math
...
a = 10
dataset = pd.read_csv(r'/home/wwj/chenqiliang/101022data/92All-channel_matrix_p_10.csv').iloc[:, 1:]
dataset = np.asarray(dataset, np.float32)
dataset = dataset.reshape(dataset.shape[0], 9, 9, 1)
label = pd.read_csv(r'/home/wwj/chenqiliang/101022data/92JTRAS_gainlabel_10.csv').iloc[:, 1]
...
class MyNetwork(nn.Module):
    def __init__(self):
        ...
        self.linear = nn.Linear(256, 1296)
