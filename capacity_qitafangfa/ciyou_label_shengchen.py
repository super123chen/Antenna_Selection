...
dataset = pd.read_csv(open(r'/home/wwj/chenqiliang/wubiaoqian/All-channel_matrix_p_50.csv')).iloc[:, 1:]
...
subCapacityData.to_csv(r'/home/wwj/chenqiliang/wubiaoqian/JTRAS_subcapacity_50.csv')
capacityLabelData.to_csv(r'/home/wwj/chenqiliang/wubiaoqian/JTRAS_capacity_label_50.csv')
subGainData.to_csv(r'/home/wwj/chenqiliang/wubiaoqian/JTRAS_subgain_50.csv')
gainLabelData.to_csv(r'/home/wwj/chenqiliang/wubiaoqian/JTRAS_gainlabel_50.csv')
